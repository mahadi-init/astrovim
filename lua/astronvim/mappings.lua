...
if is_available "toggleterm.nvim" then
  ...
  maps.i["<F2>"] = { "<Esc>" .. maps.n["<F2>"][1], desc = maps.n["<F2>"].desc }
  maps.t["<F2>"] = maps.n["<F2>"]
  maps.n["<C-'>"] = maps.n["<F2>"] -- requires terminal that supports binding <C-'>
  maps.i["<C-'>"] = maps.i["<F2>"] -- requires terminal that supports binding <C-'>
  maps.t["<C-'>"] = maps.t["<F2>"] -- requires terminal that supports binding <C-'>
end
